...
work_dirs = "work_dirs/clr/r34_rainlane_fg_only_stage2"
...
optimizer = dict(
    ...
    weight_decay=0.01,
    param_groups=[
        dict(patterns=['backbone'], lr_mult=0.3),
        dict(patterns=['neck.lrf_block'], lr_mult=2.0),
        dict(patterns=['heads'], lr_mult=1.2),
    ])
